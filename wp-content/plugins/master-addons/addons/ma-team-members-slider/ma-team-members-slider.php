								...
								<div class="jltma-team-member<?php echo esc_attr($team_preset); ?> text-center">
									<div class="jltma-team-member-thumb">
										...
										if ($team_preset == '-circle' && isset($settings['ma_el_team_circle_image'])) {
											...
											echo '<img src="' . esc_url($team_carousel_image_url) . '" class="team-slider-image" alt="' . esc_attr($member['ma_el_team_carousel_name']) . '">';
											...
											if ($settings['ma_el_team_circle_image_animation'] == "animation_svg_02") {
												...
												echo '<div class="animation_svg_02"><img src="' . esc_url($team_carousel_image_url) . '" class="team-slider-image" alt="' . esc_attr($member['ma_el_team_carousel_name']) . '"></div>';
											} elseif ($settings['ma_el_team_circle_image_animation'] == "animation_svg_03") {

												echo '<div class="animation_svg_03"></div><div class="animation_svg_03"></div><div class="animation_svg_03"></div><div class="animation_svg_03_center"><img src="' . esc_url($team_carousel_image_url) . '" class="team-slider-image" alt="' . esc_attr($member['ma_el_team_carousel_name']) . '"></div>';
											} else {
