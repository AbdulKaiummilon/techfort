...
class JLTMA_Image_Carousel extends Widget_Base
{
	...
	{
		return __('Image Carousel', JLTMA_TD);
	}
	...
	protected function jltma_image_carousel_images_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'return_value' 		=> 'yes',
				'default' 			=> 'yes',
				'label' 			=> esc_html__('Enable Lightbox Gallery?', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				...
				'label' 			=> esc_html__('Lightbox Library', JLTMA_TD),
				'description' 		=> esc_html__('Choose the preferred library for the lightbox', JLTMA_TD),
				'options' 			=> array(
					'fancybox' 		=> esc_html__('Fancybox', JLTMA_TD),
					'elementor' 	=> esc_html__('Elementor', JLTMA_TD),
				),
				'default' 			=> 'fancybox',
				'condition' 		=> [
					'enable_lightbox' => 'yes',
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				'label'     => __('Preview Icon', JLTMA_TD),
		...
		$this->add_control(
			'preview_icon',
			[
				'label'            => esc_html__('Custom Preview Icon', JLTMA_TD),
		...
		$this->add_control(
			...
			[
				'label' => __('Icon Gap to Left', JLTMA_TD),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -100,
		...
		$this->add_control(
			...
			[
				'label' => __('Icon Gap to Top', JLTMA_TD),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -100,
		...
		$this->add_control(
			...
			[
				'label'     => __('Caption Title', JLTMA_TD),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		...
		$this->add_control(
			...
			[
				'label'     => __('Caption Subtitle', JLTMA_TD),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(esc_html__('%1$s Live Demo %2$s', JLTMA_TD), '<a href="https://master-addons.com/demos/image-carousel/" target="_blank" rel="noopener">', '</a>'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => sprintf(esc_html__('%1$s Documentation %2$s', JLTMA_TD), '<a href="https://master-addons.com/docs/addons/image-carousel/?utm_source=widget&utm_medium=panel&utm_campaign=dashboard" target="_blank" rel="noopener">', '</a>'),
				'content_classes' => 'jltma-editor-doc-links',
			]
		);
		...
		if (ma_el_fs()->is_not_paying()) {
			...
			$this->start_controls_section(
				...
				[
					'label' => __('Upgrade to Pro for More Features', JLTMA_TD)
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => __('Unlock more possibilities', JLTMA_TD),
