                            ...
                            <div class="jltma-row">
                                ...
                                <div class="jltma-form-group mb-2 jltma-col-5">
                                    <label for="jltma-megamenu-width-type">
                                        <strong>
                                            <?php esc_html_e('Mega Menu Width', JLTMA_TD); ?>
                                        </strong>
                                    </label>
                                </div>
                                <div class="jltma-form-group mb-2 jltma-col-7">
                                    <select class="jltma-form-control" id="jltma-megamenu-width-type">
                                        <option value="default" selected="selected"><?php esc_html_e('Default Width', JLTMA_TD); ?></option>
                                        <option value="full_width"><?php esc_html_e('Full Width', JLTMA_TD); ?></option>
                                        <option value="custom_width"><?php esc_html_e('Custom Width', JLTMA_TD); ?></option>
                                    </select>
