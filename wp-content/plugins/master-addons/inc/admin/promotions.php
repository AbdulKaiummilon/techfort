    ...
    class Master_Addons_Promotions
    {
        ...
        public function jltma_latest_update_details()
        {
            ...
            $jltma_changelog_message = sprintf(
                 ...
                 * Starts from: %3$s
                 */
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Timeline Scroll Line updated</span><br>', JLTMA_TD), //%3$s
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Elementor Popup width issue fixed</span><br>', JLTMA_TD),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Image Hover effect popup icon issue fixed </span><br>', JLTMA_TD),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Latest Elementor support and deprecated methods updated</span><br>', JLTMA_TD) //%6$s
